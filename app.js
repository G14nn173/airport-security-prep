...
function applyResearchBasedFinalUpgrade(){
  const abstractRows=[
    ["R1","Una freccia ↑ ha un punto alla sua destra. L'intera figura ruota di 90° in senso orario. Come appare?",["Freccia → con punto sopra","Freccia ↓ con punto a sinistra","Freccia → con punto sotto","Freccia ← con punto sopra"],2,"Ruotando insieme freccia e punto di 90° in senso orario, ↑ diventa → e il lato destro originario diventa il lato inferiore.",2,"spatial_reasoning","spatial_rotation"],
    ["R2","Su una griglia 3×3 parti dal centro e ti muovi: su, destra, giù. Dove arrivi rispetto alla partenza?",["A destra","In alto a destra","In basso","Al centro"],0,"I movimenti verticale su e giù si annullano; resta uno spostamento di una casella verso destra.",1,"spatial_reasoning","spatial_path"],
    ["R3","Un triangolo orientato a destra compie prima mezzo giro e poi un quarto di giro antiorario. Qual è l'orientamento finale?",["Destra","Basso","Sinistra","Alto"],1,"Il mezzo giro porta il triangolo verso sinistra; da sinistra, un ulteriore quarto di giro antiorario lo orienta verso il basso.",2,"spatial_reasoning","orientation_change"],
    ["R4","Due pedine partono dagli angoli alto-sinistra e basso-destra di una griglia 3×3. La prima avanza una casella a destra, la seconda una casella a sinistra. Dove si trovano?",["Entrambe al centro","Alto-centro e basso-centro","Alto-destra e basso-sinistra","Centro-sinistra e centro-destra"],1,"Ogni pedina resta sulla propria riga e si sposta verso la colonna centrale: alto-centro e basso-centro.",1,"spatial_reasoning","dual_movement"],
    ["R5","A è a nord di B. C è a ovest di A. Dove si trova C rispetto a B?",["Sud-ovest","Nord-ovest","Nord-est","Ovest sulla stessa riga"],1,"C è una posizione a nord e una a ovest di B, quindi è a nord-ovest.",1,"spatial_reasoning","relative_position"],
    ["R6","Sequenza: ↑○, →●, ↓○, ?. La direzione ruota in senso orario e il riempimento alterna. Quale elemento segue?",["←○","↑●","→○","←●"],3,"Dopo ↓ la rotazione oraria produce ←; dopo ○ il riempimento deve diventare ●.",2,"spatial_reasoning","rotation_plus_attribute"],
    ["R7","Su una griglia parti dall'angolo basso-sinistra: due passi a destra, uno in alto, uno a sinistra. Dove arrivi rispetto alla partenza?",["Una casella in alto e una a destra","Due caselle a destra","Una casella in alto","Una casella in alto e una a sinistra"],0,"Il saldo orizzontale è +1 a destra e quello verticale è +1 in alto.",2,"spatial_reasoning","grid_movement"],
    ["R8","Su quattro posizioni circolari N-E-S-O, X avanza di una posizione in senso orario e Y di due. Partono da N ed E. Dove sono dopo un movimento?",["X a N, Y a O","X a E, Y a O","X a S, Y a N","X a E, Y a S"],1,"X passa da N a E; Y avanza di due posizioni da E a O.",3,"spatial_reasoning","dual_movement"],
    ["R9","<table class=\"data-table\"><tr><td>○</td><td>△</td><td>○△</td></tr><tr><td>□</td><td>●</td><td>?</td></tr></table>In ogni riga la terza cella unisce i simboli delle prime due. Cosa manca?",["□","●","○●","□●"],3,"La relazione di riga è l'unione senza modifiche: □ unito a ● produce □●.",1,"matrix_relation","row_relation","single",true],
    ["R10","<table class=\"data-table\"><tr><td>▲</td><td>▲▲</td></tr><tr><td>●●</td><td>?</td></tr></table>Da sinistra a destra la quantità raddoppia mantenendo la forma. Cosa manca?",["●●","●●●","●●●●","▲▲▲▲"],2,"La seconda riga segue la stessa relazione della prima: due cerchi raddoppiano e diventano quattro.",2,"matrix_relation","quantity_relation","single",true],
    ["R11","<table class=\"data-table\"><tr><td>○△</td><td>△□</td><td>△</td></tr><tr><td>●□</td><td>□◆</td><td>?</td></tr></table>La terza cella contiene solo il simbolo comune alle prime due. Cosa manca?",["●","◆","●◆","□"],3,"Nella seconda riga l'unico simbolo presente in entrambe le prime due celle è □.",2,"matrix_relation","intersection","single",true],
    ["R12","<table class=\"data-table\"><tr><td>○△</td><td>△</td><td>○</td></tr><tr><td>□●◆</td><td>●◆</td><td>?</td></tr></table>La terza cella sottrae dalla prima i simboli presenti nella seconda. Cosa manca?",["□","●","◆","□●"],0,"Da □●◆ si eliminano ● e ◆; resta soltanto □.",2,"matrix_relation","subtraction","single",true],
    ["R13","<table class=\"data-table\"><tr><td>↑○</td><td>→●</td></tr><tr><td>↓●</td><td>?</td></tr></table>Scendendo, la freccia ruota di 180° e il riempimento cambia. Cosa manca?",["←●","→○","↑●","←○"],3,"Da →●, ruotare di 180° dà ← e cambiare il riempimento dà ○: il risultato è ←○.",3,"matrix_relation","dual_attribute_matrix","single",true],
    ["R14","<table class=\"data-table\"><tr><td>2 cerchi</td><td>3 triangoli</td><td>5 simboli</td></tr><tr><td>4 quadrati</td><td>1 rombo</td><td>?</td></tr></table>La terza cella riporta la quantità totale della riga. Cosa manca?",["3 simboli","4 simboli","6 simboli","5 simboli"],3,"Nella seconda riga le quantità 4 e 1 si sommano: la cella finale contiene 5 simboli.",1,"matrix_relation","quantity_relation","single",true],
    ["R15","Sequenza: ↑○, →○○, ↓○○○, ?. La direzione ruota in senso orario e la quantità aumenta di uno.",["←○○○","↑○○○○","←○○○○","↓○○○○"],2,"Dopo ↓ viene ← e dopo tre simboli ne servono quattro: ←○○○○.",2,"dual_rule","orientation_and_quantity"],
    ["R16","Sequenza: alto-△, destra-□, basso-△, ?. La posizione gira in senso orario mentre la forma alterna.",["sinistra-□","sinistra-△","alto-□","destra-△"],0,"La posizione successiva è sinistra e, dopo △,□,△, la forma successiva è □.",2,"dual_rule","position_and_shape"],
    ["R17","Sequenza: ○↑, ●←, ○↓, ?. Il riempimento alterna e la freccia ruota ogni volta di 90° antiorari.",["○→","●↑","○←","●→"],3,"Dopo ○ viene ●; da ↓, una rotazione antioraria di 90° porta a →.",3,"dual_rule","fill_and_rotation"],
    ["R18","Stati successivi: quadrato-centro, cerchio-destra, quadrato-centro, cerchio-sinistra, quadrato-centro, ?. Quale stato segue?",["quadrato-destra","cerchio-destra","quadrato-sinistra","cerchio-centro"],1,"Le posizioni oscillano centro-destra-centro-sinistra-centro-destra; la forma alterna quadrato e cerchio, quindi segue cerchio-destra.",3,"dual_rule","shape_and_movement"],
    ["R19","Quale aggiunta rende la figura simmetrica rispetto a un asse verticale? A sinistra dell'asse ci sono un cerchio in alto e un quadrato in basso.",["Cerchio in alto a destra e quadrato in basso a destra","Quadrato in alto a destra e cerchio in basso a destra","Cerchio e quadrato entrambi al centro","Solo un cerchio in alto a destra"],0,"La riflessione verticale conserva altezza e forma, collocando ogni simbolo alla stessa distanza sul lato opposto.",2,"symmetry_composition","vertical_reflection"],
    ["R20","Sovrapponi due celle: la prima contiene ○ in alto-sinistra, la seconda contiene □ in basso-destra. Nessun simbolo si sovrappone. Qual è il risultato?",["Solo ○","○ in basso-destra e □ in alto-sinistra","○ in alto-sinistra e □ in basso-destra","Solo □"],2,"La composizione conserva entrambi i simboli nelle rispettive posizioni perché non vi è sovrapposizione.",1,"symmetry_composition","position_union"],
    ["R21","Una figura ha ▲ sopra un asse orizzontale e ○ sotto. Dopo la riflessione sull'asse, come appaiono?",["▲ sopra e ○ sotto","▲ a sinistra e ○ a destra","○ sopra e ▲ sotto","Entrambi sopra"],2,"La riflessione orizzontale scambia le posizioni verticali senza cambiare le forme: ○ va sopra e ▲ sotto.",2,"symmetry_composition","horizontal_reflection"],
    ["R22","Trasformazione: ABCDE → EABCD. Applica la stessa regola a KLMNO.",["KONML","OKLMN","LMNOK","ONMLK"],1,"L'ultimo elemento viene spostato all'inizio, mantenendo invariato l'ordine degli altri: OKLMN.",2,"sequence_transformation","cyclic_shift"],
    ["R23","Trasformazione: 1-2-3-4-5 → 1-3-5-2-4. Applica la stessa selezione ad A-B-C-D-E.",["A-C-E-B-D","E-C-A-D-B","A-B-D-C-E","B-D-A-C-E"],0,"Si prendono prima le posizioni dispari 1,3,5 e poi le pari 2,4: A-C-E-B-D.",3,"sequence_transformation","odd_even_reorder"],
    ["R24","Trasformazione: PQRS → QPSR. Applica la stessa regola a WXYZ.",["XWYZ","WYXZ","XWZY","WXZY"],2,"Si scambiano gli elementi di ciascuna coppia adiacente: PQ|RS diventa QP|SR, quindi WX|YZ diventa XW|ZY.",3,"sequence_transformation","adjacent_pair_swap"]
  ];
  abstractRows.forEach(r=>releaseReplace(r[0],"abstract",...r.slice(1)));

  const numericalRows=[
    ["N21","<table class=\"data-table\"><tr><td>4</td><td>7</td><td>11</td></tr><tr><td>6</td><td>9</td><td>15</td></tr><tr><td>8</td><td>?</td><td>18</td></tr></table>In ogni riga il terzo numero è la somma dei primi due. Quale numero manca?",["8","10","12","26"],1,"Nell'ultima riga 8 + ? = 18, quindi il valore mancante è 10.",1,"number_grid","row_operation","single",true],
    ["N22","<table class=\"data-table\"><tr><td>3</td><td>4</td><td>5</td></tr><tr><td>2</td><td>3</td><td>4</td></tr><tr><td>8</td><td>11</td><td>?</td></tr></table>In ogni colonna: numero inferiore = doppio del superiore + centrale. Cosa manca?",["12","13","18","14"],3,"Nella terza colonna 2×5 + 4 = 14.",2,"number_grid","column_operation","single",true],
    ["N23","<table class=\"data-table\"><tr><td>3</td><td>5</td><td>16</td></tr><tr><td>4</td><td>6</td><td>25</td></tr><tr><td>5</td><td>7</td><td>?</td></tr></table>Il terzo valore è il prodotto dei primi due più 1. Quale numero manca?",["36","35","42","13"],0,"5×7 + 1 = 36.",2,"number_grid","row_column_combination","single",true],
    ["N24","<table class=\"data-table\"><tr><td>4</td><td>3</td><td>7</td></tr><tr><td>5</td><td>2</td><td>10</td></tr><tr><td>6</td><td>4</td><td>10</td></tr><tr><td>3</td><td>5</td><td>?</td></tr></table>Le righe alternano somma e prodotto. Cosa manca?",["8","12","15","2"],2,"La prima e la terza riga usano la somma; la seconda e la quarta il prodotto. Quindi 3×5 = 15.",3,"number_grid","alternating_grid_rule","single",true],
    ["N25","Un'attività inizia alle 06:45 e dura 1 ora e 35 minuti. A che ora termina?",["08:10","08:20","08:30","07:20"],1,"06:45 + 1 ora = 07:45; aggiungendo 35 minuti si arriva alle 08:20.",1,"time_duration","elapsed_time"],
    ["N26","Una sequenza inizia alle 14:10: 25 minuti di attività, 15 minuti di pausa e 40 minuti di attività. Quando termina?",["15:30","15:20","15:40","16:10"],0,"La durata totale è 25+15+40=80 minuti; 14:10 + 80 minuti = 15:30.",2,"time_duration","timeline_sum"],
    ["N27","Una partenza prevista alle 18:25 subisce 35 minuti di ritardo. Il viaggio dura 1 ora e 20 minuti. Qual è l'orario di arrivo?",["19:45","20:00","20:35","20:20"],3,"La partenza effettiva è alle 19:00; aggiungendo 1 ora e 20 minuti si arriva alle 20:20.",3,"time_duration","delay_plus_duration"],
    ["N28","<table class=\"data-table\"><tr><th>Linea</th><th>Unità</th><th>Ore</th></tr><tr><td>A</td><td>120</td><td>6</td></tr><tr><td>B</td><td>150</td><td>10</td></tr><tr><td>C</td><td>135</td><td>9</td></tr></table>Quale linea ha la produttività oraria maggiore?",["Linea C","Linea A","Linea B","B e C alla pari con A"],1,"A produce 120/6=20 unità/ora; B e C producono 15 unità/ora. La maggiore è A.",2,"data_interpretation","rate_comparison","single",true],
    ["N29","<table class=\"data-table\"><tr><th>Giorno</th><th>Controlli</th><th>Eccezioni</th></tr><tr><td>Lunedì</td><td>80</td><td>10%</td></tr><tr><td>Martedì</td><td>120</td><td>15%</td></tr></table>Quante eccezioni in più ci sono martedì?",["8","18","10","5"],2,"Lunedì: 80×10%=8. Martedì: 120×15%=18. La differenza è 18−8=10.",2,"data_interpretation","percentage_difference","single",true],
    ["N30","<table class=\"data-table\"><tr><th>Completati</th><th>Da ricontrollare</th><th>Superano il ricontrollo</th></tr><tr><td>160</td><td>25%</td><td>3/5</td></tr></table>Quanti elementi ricontrollati non lo superano?",["16","24","40","64"],0,"Il 25% di 160 è 40. Se 3/5 superano, 2/5 non superano: 40×2/5=16.",3,"data_interpretation","table_fraction_multistep","single",true],
    ["N31","Due gruppi dividono 64 attività nel rapporto 3:5. Quante attività riceve il gruppo più piccolo?",["16","32","24","40"],2,"Le parti totali sono 8; ogni parte vale 64/8=8. Il gruppo minore riceve 3×8=24.",2,"ratio_fraction","part_to_whole_ratio"],
    ["N32","Sono stati completati i 2/3 di un lavoro e restano 18 unità. Quante unità comprendeva il lavoro?",["36","45","72","54"],3,"La parte restante è 1/3 e vale 18; il totale è quindi 18×3=54.",2,"ratio_fraction","remaining_fraction"],
    ["N33","Un valore scende da 240 a 204. Qual è la diminuzione percentuale?",["12%","15%","18%","36%"],1,"La diminuzione è 36; 36/240×100=15%.",2,"percentage_change","decrease_from_base"],
    ["N34","Una quantità di 500 viene ridotta dell'8%. Qual è il nuovo valore?",["492","450","460","540"],2,"L'8% di 500 è 40; 500−40=460.",1,"percentage_change","single_percentage_decrease"],
    ["N35","Quattro operatori completano 18 unità ciascuno ogni ora per 2,5 ore. Il 10% del totale richiede un ricontrollo. Quante unità sono ricontrollate?",["18","45","72","180"],0,"Il totale è 4×18×2,5=180; il 10% di 180 è 18.",3,"multi_step","productivity_time_percentage"],
    ["N36","Di 360 attività, il 40% è svolto al mattino. Le restanti sono divise tra pomeriggio e sera nel rapporto 5:4. Quante spettano al pomeriggio?",["96","144","216","120"],3,"Al mattino sono 144, quindi restano 216. Le 9 parti valgono 24 ciascuna; al pomeriggio spettano 5×24=120.",3,"multi_step","percentage_then_ratio"]
  ];
  numericalRows.forEach(r=>releaseReplace(r[0],"numerical",...r.slice(1)));

  const vf=["Vero","Falso","Non determinabile"];
  const verbalRows=[
    ["V61","Lente sta a osservare come righello sta a...",["disegnare","tagliare","allineare","misurare"],3,"La lente è uno strumento usato per osservare; il righello è uno strumento usato per misurare.",1,"verbal_analogy","instrument_action"],
    ["V62","Capitolo sta a libro come scena sta a...",["copertina","attore","schermo","film"],3,"Un capitolo è una parte strutturale di un libro; una scena è una parte strutturale di un film.",1,"verbal_analogy","part_whole"],
    ["V63","Attrito sta a calore come ritardo sta a...",["orario","attesa","velocità","partenza"],1,"L'attrito può produrre calore; analogamente un ritardo produce attesa.",2,"verbal_analogy","cause_effect"],
    ["V64","Triangolo sta a poligono come salmone sta a...",["fiume","squama","pesce","nuoto"],2,"Il triangolo è un esempio della categoria poligono; il salmone è un esempio della categoria pesce.",1,"verbal_analogy","category_example"],
    ["V65","Preoccupazione sta ad allarme come brezza sta a...",["vento","raffica","temporale","burrasca"],3,"Allarme esprime un'intensità maggiore di preoccupazione; burrasca esprime un'intensità maggiore di brezza.",2,"verbal_analogy","intensity_relation"],
    ["V16","Tutte le attività programmate sono registrate. L'attività Q è registrata. Valuta: “Q è programmata”.",vf,2,"Essere registrata non basta per essere programmata: la premessa vale solo da programmata a registrata. La conclusione non è determinabile.",2,"true_false_nd","converse_not_valid","vfn"],
    ["V17","Nessun incarico temporaneo è permanente. K è un incarico temporaneo. Valuta: “K non è permanente”.",vf,0,"La premessa esclude ogni incarico temporaneo dall'insieme dei permanenti; K è quindi necessariamente non permanente.",1,"true_false_nd","class_exclusion","vfn"],
    ["V18","Alcuni report sono urgenti. Tutti i report urgenti vengono revisionati. Valuta: “Alcuni report vengono revisionati”.",vf,0,"I report urgenti esistenti appartengono tutti ai revisionati; esiste quindi almeno un report revisionato.",2,"true_false_nd","existential_chain","vfn"],
    ["V19","Ogni contenitore blu è sigillato. Il contenitore J non è sigillato. Valuta: “J non è blu”.",vf,0,"Per contrapposizione, se J fosse blu sarebbe sigillato; poiché non lo è, J non può essere blu.",2,"true_false_nd","contraposition","vfn"],
    ["V20","B avviene dopo A. C avviene dopo B. Valuta: “C avviene prima di A”.",vf,1,"Le premesse impongono l'ordine A, poi B, poi C; la conclusione afferma necessariamente l'opposto ed è falsa.",1,"true_false_nd","transitive_contradiction","vfn"],
    ["V81","Anna opera prima di Bruno; Carla opera dopo Bruno. Chi occupa necessariamente la posizione centrale?",["Anna","Carla","Non determinabile","Bruno"],3,"L'unico ordine compatibile è Anna–Bruno–Carla; Bruno è necessariamente al centro.",2,"constraint_deduction","three_item_order"],
    ["V82","Tre persone L, M e N occupano le postazioni 1, 2 e 3. L non è alla 1; M è alla 3. Chi è alla postazione 1?",["M","N","L","Non determinabile"],1,"M occupa la 3. Tra L e N, L non può occupare la 1, quindi N è alla 1 e L alla 2.",2,"constraint_deduction","exclusive_assignment"],
    ["V83","Quattro attività W, X, Y e Z sono in ordine. W è immediatamente prima di X; Y è ultima; Z precede W. Qual è la seconda attività?",["X","Z","W","Y"],2,"Y è quarta; il blocco W-X deve essere preceduto da Z. L'unico ordine è Z-W-X-Y, quindi W è seconda.",3,"constraint_deduction","block_ordering"],
    ["V85","Tre cartelle K, L e M sono su ripiani alto, medio e basso. K è sopra L; M non è in alto; L è in basso. Quale cartella è sul ripiano medio?",["M","L","K","Non determinabile"],0,"Con L in basso, K deve essere in alto perché è sopra L; resta il ripiano medio per M.",3,"constraint_deduction","positional_elimination"],
    ["V46","Il responsabile ha dato indicazioni concise: poche parole, tutte direttamente utili al compito. In questo contesto, “concise” significa...",["incerte","brevi","ripetitive","severe"],1,"Il contesto specifica poche parole direttamente utili: “concise” significa brevi ed essenziali.",2,"vocabulary_context","context_definition"],
    ["V47","Il controllo è stato differito: verrà svolto domani invece che oggi. In questo contesto, “differito” significa...",["annullato","anticipato","rimandato","semplificato"],2,"La frase chiarisce che il controllo non è cancellato ma spostato a domani: è rimandato.",1,"vocabulary_context","contextual_temporal_meaning"]
  ];
  verbalRows.forEach(r=>releaseReplace(r[0],"verbal",...r.slice(1)));

  const situationalRows=[
    ["S1","Durante un picco di attività senti aumentare la pressione e noti che stai accelerando oltre il ritmo abituale. Qual è la risposta PIÙ efficace?",["Continui allo stesso ritmo per non creare ritardi, ricontrollando tutto alla fine.","Chiedi a un collega di assumere il compito senza spiegare il motivo.","Riduci soltanto i controlli che ritieni meno rilevanti finché il flusso cala.","Ristabilisci un ritmo controllato, mantieni i passaggi previsti e segnali il carico se serve supporto."],3,"Autocontrollo significa riconoscere l'effetto della pressione, preservare il processo e comunicare tempestivamente un bisogno reale di supporto.",3,"self_control","pressure_regulation"],
    ["S2","Un passeggero irritato contesta il tempo di attesa ma continua a collaborare. Qual è la risposta PIÙ efficace?",["Gli chiedi di attendere in silenzio per non rallentare ulteriormente il flusso.","Riconosci il disagio con tono calmo, dai un'informazione essenziale e prosegui con coerenza.","Gli fornisci una spiegazione molto dettagliata finché accetta pienamente la situazione.","Passi subito la conversazione a un collega anche se puoi gestirla senza interrompere il lavoro."],1,"Una risposta breve, calma e coerente riduce la tensione senza promettere ciò che non si può garantire né bloccare inutilmente l'attività.",2,"passenger_communication","irritated_but_cooperative"],
    ["S3","Devi decidere come proseguire, ma una comunicazione ricevuta manca del dato che distingue due procedure possibili. Qual è la risposta PIÙ efficace?",["Mantieni la situazione controllata e chiedi il dato mancante alla fonte competente prima di scegliere.","Applichi la procedura più comune e chiedi conferma quando il dato sarà disponibile.","Confronti informalmente le due procedure e scegli quella che sembra più prudente.","Rimandi ogni attività collegata anche se alcune parti possono essere svolte senza quel dato."],0,"Quando l'informazione mancante determina la scelta, occorre preservare il controllo e ottenere una conferma affidabile prima di procedere.",3,"information_quality","missing_decision_data"],
    ["S4","Hai diverse attività aperte e due colleghi ti inviano nuove richieste quasi contemporaneamente. Qual è la risposta PIÙ efficace?",["Le affronti nell'ordine di arrivo per applicare un criterio uguale a tutte.","Completi prima tutte le attività brevi così da ridurre rapidamente la lista.","Valuti rischio, scadenze e dipendenze, comunichi le priorità e coordini eventuale supporto.","Dividi il tempo in parti uguali fra tutte le richieste per farle avanzare insieme."],2,"Con carico elevato serve una priorità esplicita basata sul contesto, accompagnata da comunicazione e coordinamento, non un criterio puramente meccanico.",3,"workload_management","risk_deadline_dependencies"],
    ["S5","Noti che una persona tenta più volte di accedere a una zona diversa da quella indicata, guardando alternativamente i cartelli e il proprio documento. Qual è la risposta PIÙ efficace?",["Concludi che il comportamento è sospetto e richiedi immediatamente il massimo livello di intervento.","Osservi senza intervenire finché la persona non supera fisicamente il limite indicato.","Verifichi la situazione con approccio neutro e applichi l'eventuale procedura in base a fatti osservabili.","Chiedi ad altri presenti che impressione hanno della persona prima di decidere."],2,"La risposta proporzionata usa fatti osservabili, chiarisce la situazione senza profilazione e applica l'escalation prevista solo se gli elementi lo richiedono.",2,"observable_anomaly","neutral_verification"],
    ["S6","Un collega propone di saltare una verifica perché il risultato precedente era regolare e il flusso sta aumentando. Qual è la risposta PIÙ efficace?",["Mantieni la verifica prevista e proponi invece un'organizzazione del flusso compatibile con i controlli.","Accetti solo per i casi che sembrano simili a quello già verificato.","Chiedi al collega di assumersi formalmente la responsabilità della scorciatoia.","Rinvii la decisione finché il flusso non rende inevitabile scegliere."],0,"Un risultato precedente non sostituisce la verifica corrente; la pressione va gestita organizzando il lavoro senza introdurre scorciatoie arbitrarie.",3,"procedural_integrity","shortcut_request"],
    ["S9","Subito dopo aver concluso una registrazione scopri di aver trascritto un valore errato, ma l'attività successiva sta iniziando. Qual è la risposta PIÙ efficace?",["Annoti mentalmente l'errore e lo correggi appena termina l'attività successiva.","Chiedi a un collega di correggerlo senza interrompere la nuova attività.","Correggi direttamente il valore e comunichi solo se qualcuno chiede chiarimenti.","Metti in sicurezza la nuova attività, segnali l'errore e lo correggi secondo il processo previsto."],3,"Un errore appena rilevato va reso tracciabile e corretto tempestivamente, coordinando la continuità del lavoro invece di nasconderlo o delegarlo informalmente.",3,"accountability","newly_detected_error"],
    ["S10","Durante un cambio operativo il collega usa un termine ambiguo per descrivere un'attività ancora aperta. Qual è la risposta PIÙ efficace?",["Interpreti il termine in base a come viene usato di solito nel gruppo.","Chiedi di precisare stato, azione residua e responsabilità prima di concludere il passaggio.","Accetti il passaggio e verifichi i dettagli quando inizierai l'attività.","Riporti la stessa formulazione ambigua nelle note per non alterare il messaggio."],1,"Una consegna efficace elimina l'ambiguità prima del trasferimento, rendendo chiari stato, lavoro residuo e responsabilità.",2,"team_communication","handover_clarification"],
    ["S11","Una verifica programmata sta per scadere mentre arriva una segnalazione potenzialmente rilevante ma ancora non confermata. Qual è la risposta PIÙ efficace?",["Valuti rapidamente la segnalazione, assicuri copertura e coordini la gestione di entrambe le priorità.","Completi la verifica in scadenza e consideri la segnalazione soltanto dopo.","Interrompi ogni attività per occuparti personalmente della segnalazione fino alla chiusura.","Assegni la segnalazione al primo collega disponibile senza verificarne ruolo o informazioni."],0,"Le priorità concorrenti richiedono una valutazione iniziale, copertura e coordinamento proporzionato; non vanno ignorate né gestite entrambe in modo impulsivo.",3,"competing_priorities","triage_and_coordination"],
    ["S12","Osservi una sequenza insolita di aperture e chiusure di una porta controllata, senza vedere una causa evidente. Qual è la risposta PIÙ efficace?",["Intervieni sul dispositivo seguendo la soluzione tecnica che ritieni più probabile.","Aspetti un secondo episodio per evitare una segnalazione forse inutile.","Mantieni l'area sotto controllo, raccogli gli elementi osservabili e coinvolgi il referente appropriato.","Chiedi alle persone vicine se hanno già visto episodi simili e decidi in base alle risposte."],2,"Una situazione insolita va documentata con elementi osservabili e portata al livello competente, mantenendo il controllo senza diagnosi improvvisate.",2,"appropriate_escalation","unexplained_repeated_event"]
  ];
  situationalRows.forEach(r=>releaseReplace(r[0],"situational",...r.slice(1),"best"));

  const inboxRows=[
    ["I1","Per completare il report delle 11:00 serve un dato che il collega può fornire entro dieci minuti; intanto hai una verifica indipendente da chiudere entro le 10:50. Cosa fai?",["Aspetti il dato senza iniziare altro per essere pronto a chiudere il report.","Richiedi subito il dato e svolgi la verifica indipendente durante l'attesa.","Completi il report stimando il dato e correggi eventualmente dopo.","Rimandi la verifica finché il report non è stato consegnato."],1,"Si attiva subito la dipendenza esterna e si usa il tempo di attesa per il compito indipendente con scadenza precedente.",2,"dependency_management","parallel_waiting_work"],
    ["I2","Due attività scadono insieme: una richiede la tua abilitazione, l'altra è standard e un collega qualificato è disponibile. Come procedi?",["Inizi l'attività standard perché è più rapida e lasci in attesa quella specialistica.","Alterni personalmente le due attività per mantenerle entrambe in avanzamento.","Chiedi al collega di osservarti sull'attività specialistica mentre svolgi quella standard.","Assumi l'attività non delegabile e concordi con il collega responsabilità e verifica di quella standard."],3,"La delega efficace rispetta competenze e responsabilità: tu copri il vincolo non trasferibile e assegni chiaramente il compito standard.",2,"delegation","capability_based_delegation"],
    ["I3","Alle 15:00 devi inviare un riepilogo di cinque minuti; alle 15:05 inizia una verifica di trenta minuti che richiede preparazione immediata. Sono le 14:50. Cosa fai?",["Completi prima il riepilogo e inizi a preparare la verifica alle 15:00.","Prepari ora la verifica, invii il riepilogo alle 15:00 e inizi puntualmente alle 15:05.","Avvii la verifica in anticipo e invii il riepilogo quando trovi una pausa.","Chiedi di rinviare entrambe le scadenze per evitare sovrapposizioni."],1,"La preparazione anticipata elimina il conflitto: il compito breve resta nella sua finestra e la verifica può iniziare puntualmente.",3,"competing_deadlines","backward_scheduling"],
    ["I4","Mentre completi un controllo con scadenza tra venti minuti, arriva una richiesta imprevista risolvibile in due minuti e necessaria per sbloccare tre colleghi. Cosa fai?",["Ignori la richiesta fino alla chiusura del controllo per non cambiare attività.","Abbandoni il controllo e ti rendi disponibile anche per eventuali richieste successive.","Deleghi la richiesta senza verificare se la persona scelta possiede le informazioni necessarie.","Metti in pausa in modo tracciabile il controllo, risolvi la richiesta breve e riprendi subito."],3,"L'interruzione breve ha alto impatto collettivo e può essere assorbita senza compromettere la scadenza, purché la pausa sia controllata e il lavoro venga ripreso subito.",2,"unexpected_interruption","high_impact_short_interrupt"],
    ["I5","Hai una consegna obbligatoria tra dieci minuti. Un indicatore segnala anche un possibile sovraccarico tra un'ora, prevenibile con un controllo di quindici minuti. Cosa fai?",["Avvii subito il controllo preventivo e consegni il documento quando possibile.","Completi la consegna e aspetti che il sovraccarico diventi certo prima di agire.","Concludi la consegna, pianifichi immediatamente il controllo preventivo e ne comunichi la finestra.","Tratti il controllo futuro come prioritario e deleghi la consegna senza passaggio di informazioni."],2,"La scadenza presente può essere rispettata senza perdere la prevenzione: il rischio futuro viene programmato e comunicato prima che diventi urgente.",2,"future_risk","present_deadline_future_prevention"],
    ["I6","Al cambio turno restano un'attività sospesa per autorizzazione, una scadenza tra trenta minuti e una nota non urgente. Qual è il passaggio di consegne migliore?",["Indichi stato e dipendenza dell'attività sospesa, evidenzi la scadenza e assegni chiaramente il seguito; segnali infine la nota differibile.","Comunichi soltanto la scadenza più vicina e lasci che il collega ricostruisca il resto dalle registrazioni.","Completi la nota non urgente per ridurre il numero di elementi da trasferire.","Elenca tutte le attività nello stesso ordine senza distinguere dipendenze, tempi o responsabilità."],0,"Una consegna utile rende espliciti dipendenza, urgenza, stato e responsabilità, distinguendo ciò che può essere differito.",3,"handover","dependency_deadline_transfer"]
  ];
  inboxRows.forEach(r=>releaseReplace(r[0],"inbox",...r.slice(1)));
}
applyResearchBasedFinalUpgrade();
...
function addBalanced(pool,addCount,seed,chosen,totalCount,familyCap=Infinity){
  const available=seededShuffle(pool.filter(x=>!chosen.some(y=>y.id===x.id)),seed),familyCounts={},mechanismCounts={},diffCounts={1:0,2:0,3:0},diffTargets={1:Math.round(totalCount*.25),2:Math.round(totalCount*.5)};
  diffTargets[3]=totalCount-diffTargets[1]-diffTargets[2];
  chosen.forEach(x=>{familyCounts[x.family]=(familyCounts[x.family]||0)+1;mechanismCounts[x.mechanism||x.family]=(mechanismCounts[x.mechanism||x.family]||0)+1;diffCounts[x.diff]=(diffCounts[x.diff]||0)+1;});
  while(addCount>0&&available.length){
    const withinCap=available.filter(x=>(familyCounts[x.family]||0)<familyCap),capPool=withinCap.length?withinCap:available;
    const withinDiff=capPool.filter(x=>diffCounts[x.diff]<(diffTargets[x.diff]??totalCount)),diffPool=withinDiff.length?withinDiff:capPool;
    const minFamily=Math.min(...diffPool.map(x=>familyCounts[x.family]||0)),familyPool=diffPool.filter(x=>(familyCounts[x.family]||0)===minFamily);
    const minMechanism=Math.min(...familyPool.map(x=>mechanismCounts[x.mechanism||x.family]||0)),candidate=familyPool.find(x=>(mechanismCounts[x.mechanism||x.family]||0)===minMechanism),index=available.indexOf(candidate);
    chosen.push(candidate);available.splice(index,1);addCount--;
    familyCounts[candidate.family]=(familyCounts[candidate.family]||0)+1;mechanismCounts[candidate.mechanism||candidate.family]=(mechanismCounts[candidate.mechanism||candidate.family]||0)+1;diffCounts[candidate.diff]=(diffCounts[candidate.diff]||0)+1;
  }
  return chosen;
}
function pickStratified(cat,count,seed){return addBalanced(BANK.filter(x=>x.cat===cat),count,seed,[],count);}
function pickAssessmentSection(cat,count,seed){
  const pool=BANK.filter(x=>x.cat===cat),chosen=[];
  if(cat==="abstract"){
    const spatial=x=>x.family==="spatial_reasoning"||x.family==="spatial_position"||x.family==="rotation";
    const matrix=x=>x.family==="matrix_relation"||x.family==="symmetry_composition";
    const dual=x=>!spatial(x)&&!matrix(x);
    addBalanced(pool.filter(spatial),8,seed+11,chosen,count);
    addBalanced(pool.filter(matrix),7,seed+23,chosen,count);
    addBalanced(pool.filter(dual),5,seed+37,chosen,count);
  }else if(cat==="numerical"){
    const data=x=>["number_grid","data_interpretation"].includes(x.family);
    const multi=x=>x.family==="multi_step";
    const timeRatioPct=x=>["time_duration","time_rate","ratio_fraction","ratio","fraction","percentage_change","percentage","conversion"].includes(x.family);
    addBalanced(pool.filter(data),2,seed+11,chosen,count);
    addBalanced(pool.filter(timeRatioPct),2,seed+23,chosen,count);
    addBalanced(pool.filter(multi),2,seed+37,chosen,count);
    addBalanced(pool,count-chosen.length,seed+53,chosen,count);
  }else if(cat==="verbal"){
    const inference=x=>["true_false_nd","implication","syllogism","relational_logic"].includes(x.family);
    const analogy=x=>x.family==="verbal_analogy"||x.family==="analogy";
    const deduction=x=>x.family==="constraint_deduction"||x.family==="deduction";
    addBalanced(pool.filter(inference),5,seed+11,chosen,count);
    addBalanced(pool.filter(analogy),3,seed+23,chosen,count);
    addBalanced(pool.filter(deduction),2,seed+37,chosen,count);
    addBalanced(pool,count-chosen.length,seed+53,chosen,count);
  }else if(cat==="situational"){
    addBalanced(pool,count,seed,chosen,count,2);
  }else if(cat==="inbox"){
    addBalanced(pool,count,seed,chosen,count,1);
  }else{
    addBalanced(pool,count,seed,chosen,count);
  }
  if(chosen.length<count)addBalanced(pool,count-chosen.length,seed+71,chosen,count);
  return chosen;
}
function startAssessment(){const qs=[],sections=[];let cursor=0;ASSESSMENT_SECTIONS.forEach((s,i)=>{const chosen=pickAssessmentSection(s.cat,s.count,Date.now()+i*997);const indexes=chosen.map((_,k)=>cursor+k);qs.push(...chosen);sections.push({...s,indexes});cursor+=chosen.length;});state={mode:"assessment",questions:qs,answers:{},flagged:{},current:0,sections,sectionIndex:0,sectionRemaining:sections[0].seconds,totalRemaining:3600,duration:3600,startedAt:Date.now(),completed:false};showQuiz();startTimer();saveSession();}
